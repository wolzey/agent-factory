...
import lighter from '../../docs/evidence/changelog/2026-09-23.png';
...
const captures: Record<string, {src:string; alt:string; width:number; height:number; frame?: {x:number; y:number; width:number; height:number}}> = {
  '2026-09-23-lighter': {src:lighter,alt:'The lounge: the floor lamp, a candle on the coffee table, the couch, and the DJ booth',width:800,height:564,frame:{x:400,y:395,width:400,height:165}},
